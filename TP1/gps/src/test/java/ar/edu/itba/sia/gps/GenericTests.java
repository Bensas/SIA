...
public class GenericTests {
	...
	public static void solutionFound(GPSEngine engine){
		...
		assert !engine.isFailed() : String.format("After findSolution with a no solution problem, the failed flag was not set, with %s strategy", engine.getStrategy().name());
